...
1. 先阅读 `docs/DOCUMENTATION_CATALOG.md`，再按其中的 AI 阅读顺序阅读 `README.md`、`docs/README.md`、`docs/PRODUCT.md`、`docs/ARCHITECTURE.md`、`docs/DATA_MODEL.md` 和 `docs/DECISIONS.md`。
2. 检查当前分支与工作区，保护用户已有改动。
3. 当前版本只记录自慰和做爱两个固定、独立模块；不得引入活动表、活动类型、健身或自定义活动抽象。未来记录类型必须通过新 ADR 作为独立垂直模块加入。
...
7. 新增、移动、重命名或删除任何 Markdown/文档文件时，必须同步更新 `docs/DOCUMENTATION_CATALOG.md`；不要把历史审计文档当作当前事实入口。
