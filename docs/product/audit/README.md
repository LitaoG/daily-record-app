...
| [2026-08-09 Issue #105 Stage 4–5](2026-08-09-record-details-stage4-stage5/README.md) | 记录页无障碍、窄屏、恢复、跨设备与候选 APK | 已合入 main（PR #119），#105 已关闭 |
...
- 最新一次代码级合入是公共 `main` 的 PR #119（含 #105 逐次详情、设置中心与同步加固）；#104 自愈测试与 ADR-017 见 PR #120。验证结果以 PR/CI 和当前代码为准。
