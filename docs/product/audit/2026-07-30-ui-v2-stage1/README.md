...
- 自慰主色为 `#85569A`，深色为 `#603670`。
- 做爱主色为 `#A54658`，深色为 `#7A3040`。
...
- 两个半区宽度均为外框的 `1/2`。
- 外框与两个半区最小高度均为 52dp。
- 正常静止状态下，完整选中半区的采样色分别等于自慰主色和做爱主色。
- 200% 字体下模块半区、周期标签和底部导航仍满足 48dp/52dp 门槛。

语义树：

- [自慰日历](01-calendar-hand-semantics.xml)
...
- [自慰日历](01-calendar-hand.png)
- [做爱日历](02-calendar-sex.png)
- [自慰统计](03-statistics-hand.png)
